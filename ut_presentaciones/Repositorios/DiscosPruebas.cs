...
namespace ut_presentacion.Repositorios
{
    ...
    public class DiscosPruebas
    {
        ...
        public void Ejecutar()
        {
            ...
            contextoReal.Database.ExecuteSqlRaw("DISABLE TRIGGER tr_Delete_Discos ON Discos");
            ...
            contextoReal.Database.ExecuteSqlRaw("ENABLE TRIGGER tr_Delete_Discos ON Discos");
        }
