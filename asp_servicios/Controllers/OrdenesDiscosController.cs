...
namespace asp_servicios.Controllers
{
    ...
    public class OrdenesDiscosController : ControllerBase
    {
        private IOrdenesDiscosAplicacion? iAplicacion = null;
        private TokenController? tokenController = null;

        public OrdenesDiscosController(IOrdenesDiscosAplicacion? iAplicacion, TokenController tokenController)
        {
